...
export interface ResponsesStreamState {
  ...
  functionCallArgumentsByOutputIndex: Map<number, string>
...
export const createResponsesStreamState = (): ResponsesStreamState => ({
  ...
  functionCallArgumentsByOutputIndex: new Map(),
...
const handleOutputItemAdded = (
  ...
  if (initialArguments !== undefined) {
    state.functionCallArgumentsByOutputIndex.set(outputIndex, initialArguments)
    ...
    state.functionCallArgumentsByOutputIndex.set(outputIndex, "")
  }
...
const handleFunctionCallArgumentsDelta = (
  ...
  const buffered =
    state.functionCallArgumentsByOutputIndex.get(outputIndex) ?? ""
  state.functionCallArgumentsByOutputIndex.set(
    outputIndex,
    `${buffered}${deltaText}`,
  )
...
const handleFunctionCallArgumentsDone = (
  ...
  state.functionCallArgumentsByOutputIndex.delete(outputIndex)
...
const closeAllOpenBlocks = (
  ...
  state.functionCallArgumentsByOutputIndex.clear()
